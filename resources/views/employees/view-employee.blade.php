...
@section('pageTitle', 'View Employee')
            ...
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle"
                  src="{{ asset('avatar/'.$view_employee->profile_image) }}"
              ...
              <div class="tab-content">
                ...
                <div class=" tab-pane" id="to-do-list">
                  <div class="row">
                        ...
                        <ul class="todo-list" data-widget="todo-list">
                          ...
                          <li>
                              ...
                              <div class="tools">
                                ...
                                <form action="{{ route('delete.to_do', $to_do->id) }}" method="post" style="display:inline;">
                                  @method('DELETE')
                                  @csrf
                    ...
                    <div class="col-md-12">
                        <button type="button" class="btn btn-dark btn-sm float-right mt-1" data-toggle="modal" data-target="#to-do-modal"><i class="fas fa-plus"></i> Add item</button>
                    </div>
                    <div class="modal fade" id="to-do-modal">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          
                          <div class="modal-header">
                            <h4 class="modal-title">{{ (isset($to_do_edit))? 'Update To Do Item':'Add To Do Item' }}</h4>
                          ...
                          <div class="modal-body">
                            ...
                            <form action="" method="POST" id="add_to_do_form" class="" style="margin:auto;">
        
                              @csrf 
                              <div class="form-group">
                                <input type="text" name="employee_id" id="" value="{{ $view_employee->id }}" hidden>
                                <input type="hidden" name="action" id="action" value="Add" >
                                <input type="text" name="status" id="" value="0" hidden>
                                <input type="text" name="to_do_item" class="form-control" id="item" value="" placeholder="Enter Item Here">
                              ...
                              <button type="submit" class="btn btn-dark btn-sm float-right">Add</button>
                            </form>
                          </div>
